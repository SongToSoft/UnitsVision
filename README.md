# UnitsVision
Данная программа работает с множеством юнитов.
Каждый юнит характеризуется своей позицией на 2D поле и направлением куда он смотрит.
Исходя из данных характеристик программа проверяет сколько других юнитов видит каждый из них.
Область видимости юнита определяется, как сектор круга, с центром в направлении взгляда юнита.
Каждый такой сектор помимо направления характеризуется едиными для всех юнитов параметрами: радиусом и углом обзора.
